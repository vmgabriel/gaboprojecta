...
class SteresCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gaboprojectas:steress")
...
def delete_steres_view(request, pk):
    ...
    steres.delete()
    return redirect("gaboprojectas:steress")
...
class UserCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gaboprojectas:users")
...
def delete_user_view(request, pk):
    ...
    user.delete()
    return redirect("gaboprojectas:users")
...
class PreductsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gaboprojectas:preductss")
...
def delete_preducts_view(request, pk):
    ...
    preducts.delete()
    return redirect("gaboprojectas:preductss")
...
class SheppingcartCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gaboprojectas:sheppingcarts")
...
def delete_sheppingcart_view(request, pk):
    ...
    sheppingcart.delete()
    return redirect("gaboprojectas:sheppingcarts")
